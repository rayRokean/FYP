...
<div id="container">
	...
	<div id="body">
		<form action="processAddCaterer.php" method="post" name="ctForm">
			Caterer ID:
			...
			Caterer Name:<br>
				<input type="text" name="ctName" id="ctName" autocomplete=off required><br><br>
				
			Food Type:<br>
				<input type="checkbox" id="cbLocal" name="ctLocal" value="Local">Local<br>
				<input type="checkbox" id="cbWestern" name="ctWestern" value="Western">Western<br>
				
				<input type="checkbox" id="cbOthers" name="ctOthers" value="Others" onclick="toggleForm('document.ctForm','ctOthers','txtOthers')">Others(Please Specify):
				<input type="text" id="txtOthers" name="ctSpecify" disabled=true><br><br>
				
			Email Address:<br>
				<input type="text" name="ctEmail" id="ctEmail" required><br><br>
				
			Phone Number<br>
				<input type="text" name="ctPhone" id="ctPhone" required><br><br>
